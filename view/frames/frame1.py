...
class Frame1(ctk.CTkFrame):
    def __init__(self, master, click_option_var, **kwargs):
        ...
        self.entry_hour = ctk.CTkEntry(self, width=50, justify="center", border_width=0, corner_radius=10)
        ...
        self.entry_mins = ctk.CTkEntry(self, width=50, justify="center", border_width=0, corner_radius=10)
        ...
        self.entry_secs = ctk.CTkEntry(self, width=50, justify="center", border_width=0, corner_radius=10)
        ...
        self.entry_millis = ctk.CTkEntry(self, width=50, justify="center", border_width=0, corner_radius=10)
        ...
        self.entry_random_millis_start = ctk.CTkEntry(self, width=50, justify="center", border_width=0, corner_radius=10)
        self.entry_random_millis_start.grid(row=1, column=5, padx=(0,4), pady=15)
        self.entry_random_millis_start.insert(0, 50)
        ...
        self.entry_random_millis_end = ctk.CTkEntry(self, width=50, justify="center", border_width=0, corner_radius=10)
